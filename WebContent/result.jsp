...
<!-- the very top part -->
     <div class="top" style="letter-spacing: 2px;">
        <ul>
			...
			<% } else {%>
    			 <li style="padding-right: 30px;" class="barlist" id="admin"><a href="main.jsp#login"=>LogIn/SignUp</a></li>
			<% } %>
 ...
 <div class="recom">
        ...
        <h1 id="result">We found ${resultrecipes.size()} dish(es) based on your requirements.</h1>
       <c:forEach items="${resultrecipes}" var ="recipe">
	        <div class="food-card">
